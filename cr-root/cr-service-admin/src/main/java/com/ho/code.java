...
public class code {
    ...
    private static final String OUT_PUT_DIR = System.getProperty("user.dir") + "/cr-root/cr-service-admin/src/main/java";
    private static final String DB_URL = "jdbc:mysql://localhost:3306/crp_auth?useSSL=false&serverTimezone=GMT%2B8&useUnicode=true&characterEncoding=utf-8";
    ...
    public static void main(String[] args) {
        ...
        strategy.setInclude("crp_industry")//映射的表
                .setTablePrefix("crp_")
